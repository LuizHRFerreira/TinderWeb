        ...
        <ul class="list-inline">
            ...
            @foreach($options->where('characteristics_id', $characteristic->id) as $option)  
                        ...
                        @php
                            ...
                            # Verifica se a coluna i_am existe e não é nula antes de tentar decodificar
                            $selectedOptions = [];
                            if ($userOptions && $userOptions->i_am) {
                                $selectedOptions = json_decode($userOptions->i_am, true);
                            }

                            # Verifica se as opções listadas na coluna i_am do usuário estão entre as opções listadas
